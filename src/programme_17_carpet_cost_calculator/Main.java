 ...
 * PRIME TESTINGThe class needs to have one constructor with parameters width and length of type double and it
 ...
 * PRIME TESTINGfloor = new Floor(5.4, 4.5);
 ...
 * NOTE: In total, you have to write 4 classe
 */
public class Main {
